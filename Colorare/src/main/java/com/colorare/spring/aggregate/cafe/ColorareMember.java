...
import com.colorare.spring.aggregate.cafe.vo.Address;
import com.colorare.spring.shared.NameValue;
import com.colorare.spring.shared.NameValueList;
import com.colorare.spring.util.exception.InvalidEmailException;
...
@Getter
@Setter
public class ColorareMember extends Entity {
	//
	...
	public ColorareMember() {
		//
		super();
		this.addresses = new ArrayList<>();
	}

	public ColorareMember(String id) {
		//
		super(id);
	}

	public ColorareMember(String email, String name, String phoneNumber) {
		//
		this();
		this.email = email;
		this.name = name;
	...
	public static ColorareMember sample() {
		//
		ColorareMember member = new ColorareMember("mymy@nextree.co.kr", "Minsoo Lee", "010-3321-1001");
